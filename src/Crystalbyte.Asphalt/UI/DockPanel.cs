...
namespace Crystalbyte.Asphalt.UI {
    ...
    public class DockPanel : Panel {
        ...
        ///   added to a <see cref="T:Crystalbyte.Asphalt.UI.DockPanel" />
        ///   resizes to fill the remaining space.
        /// </summary>
        /// <value> True if the last element added resizes to fill the remaining space, false to indicate the last element does not resize. The default is true. </value>
        ...
        /// <summary>
        ///   Identifies the
        ///   <see cref="P:Crystalbyte.Asphalt.UI.DockPanel.LastChildFill" />
        ///   dependency property.
        /// </summary>
        ...
        /// </summary>
        /// <param name="element"> The element to which the attached property is assigned. </param>
        /// <param name="dock"> The dock value to assign to the specified element. </param>
        [SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters",
            Justification = "DockPanel only has UIElement children")]
        ...
        ///   <see cref="T:Crystalbyte.Asphalt.UI.DockPanel" /> in preparation
        ///   for arranging them during the
        ///   <see cref="M:Crystalbyte.Asphalt.UI.DockPanel.ArrangeOverride(System.Windows.Size)" />
        ///   pass.
        /// </summary>
        /// <param name="constraint"> The area available to the <see cref="T:Crystalbyte.Asphalt.UI.DockPanel" /> . </param>
        /// <returns> The desired size of the <see cref="T:Crystalbyte.Asphalt.UI.DockPanel" /> . </returns>
        ...
        ///   <see cref="T:Crystalbyte.Asphalt.UI.DockPanel" /> control.
        /// </summary>
        /// <param name="arrangeSize"> The area in the parent element that the <see cref="T:Crystalbyte.Asphalt.UI.DockPanel" /> should use to arrange its child elements. </param>
        /// <returns> The actual size of the <see cref="T:Crystalbyte.Asphalt.UI.DockPanel" /> after the child elements are arranged. The actual size should always equal <paramref
        ///    name="arrangeSize" /> . </returns>
        [SuppressMessage("Microsoft.Naming", "CA1725:ParameterNamesShouldMatchBaseDeclaration", MessageId = "0#",
            Justification = "Compat with WPF.")]
